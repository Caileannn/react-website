      ...
      <div className="content-container">
        <div className="content-text">
          <div className="text-body">
            ...
            <p>This audio-visual performance was created in response to the “Portraits: People & Place” exhibition at the WGOA (Waterford Gallery of Art). The performance explored the role portraits hold in the digital age, and how our perception of the ‘subject’ or ‘sitter’ has in some ways changed to facilitate virtual interactions. For this performance, I collaborated with local sound artist and producer <a className='evan-link' href='https://www.instagram.com/theevanmiles/' rel="noreferrer" target="_blank">Evan Miles</a>, to produce visuals in response to his music. Our aim was to understand what meaning has been lost or gained during this digital conversion, and in what ways can we reimagine our digital identity through sound, and video.</p>
